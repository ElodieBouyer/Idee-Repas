...
public class TABLEINGREDIENTMEAL {
	...
	public static final String CREATE_TABLE_INGREDIENTMEAL = 
			"CREATE TABLE " + TAB_INGREDIENTMEAL + " (" 
					...
					+ "FOREIGN KEY("   + COL_ID_MEAL       + ")" + " REFERENCES " + TABLEMEAL.TAB_MEALS             + "(" + TABLEMEAL.COL_ID        + ") ON DELETE CASCADE," 
					+ "FOREIGN KEY("   + COL_ID_INGREDIENT + ")" + " REFERENCES " + TABLEINGREDIENT.TAB_INGREDIENTS + "(" + TABLEINGREDIENT.COL_ID  + ") ON DELETE CASCADE,"
				    + "PRIMARY KEY("   + COL_ID_MEAL + "," + COL_ID_INGREDIENT + "));";
}
